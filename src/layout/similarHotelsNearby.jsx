...
function HotelCard({ hotel }) {
  ...
  return (
    <section className="flex justify-center items-center flex-col w-full h-full bg-neutral-primary-soft p-6 shadow-xs group cursor-pointer hover:shadow-md transition-all">
      <div className="border border-default rounded-[32px] ">
